<div class="flex flex-col items-center justify-center h-full space-y-4">
	<div class="flex [&>*]:flex [&>*]:items-center [&>*]:justify-center">
		...
		<div class="w-20 h-20 bg-accent-4">4</div>
		...
		<div class="w-20 h-20 bg-accent-14">14</div>
		<div class="w-20 h-20 bg-accent-15">15</div>
		<div class="w-20 h-20 bg-accent-16">16</div>
	</div>
	<div class="flex [&>*]:flex [&>*]:items-center [&>*]:justify-center">
		<div class="w-40 h-40 bg-surface-1">
			<p>Surface</p>
			<span>1</span>
		</div>
		<div class="w-40 h-40 bg-surface-2">
			<p>Surface</p>
			<span>2</span>
		</div>
		<div class="w-40 h-40 bg-surface-3">
			<p>Surface</p>
			<span>3</span>
		</div>
	...
	<h2 class="text-text-2">Welcome to Skeleton.</h2>
</div>
