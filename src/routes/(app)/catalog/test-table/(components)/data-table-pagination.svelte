<script lang="ts">
	import RadixIconsChevronRight from '$lib/icons/RadixIconsChevronRight.svelte';
	import RadixIconsChevronLeft from '$lib/icons/RadixIconsChevronLeft.svelte';
	...
	<div class="flex items-center space-x-6 lg:space-x-8">
		...
		<div class="flex items-center space-x-2">
			...
			>
				...
				<RadixIconsDoubleArrowLeft size={15} />
			</Button>
			<Button
				variant="outline"
				class="h-8 w-8 p-0"
			...
			>
				...
				<RadixIconsChevronRight size={15} />
			</Button>
			<Button
				variant="outline"
				class="hidden h-8 w-8 p-0 lg:flex"
			...
			>
				...
				<RadixIconsDoubleArrowRight size={15} />
			</Button>
		</div>
	</div>
</div>
