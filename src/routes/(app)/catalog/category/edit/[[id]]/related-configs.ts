...
export const createChannelMappingConfig = (c_channels: Array<{ value: number; label: string }>) =>
	createRelatedTableConfig<
...
export function createTabConfigs(data: {
	...
	// Create channel mapping config with the provided channels data
	const channelMappingConfig = createChannelMappingConfig(data.c_channels);
