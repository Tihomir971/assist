  ...
  public: {
    Tables: {
      ...
      c_bpartner_location: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "c_bpartner_location_l_location_id_fkey"
            columns: ["l_location_id"]
            referencedRelation: "l_location"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      c_channel_map_brand: {
        ...
        Relationships: [
          {
            foreignKeyName: "c_channel_map_brand_c_channel_id_fkey"
            columns: ["c_channel_id"]
            referencedRelation: "c_channel"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "c_channel_map_brand_m_product_brands_id_fkey"
            columns: ["m_product_brands_id"]
      ...
      c_channel_map_product: {
        ...
        Relationships: [
          {
            foreignKeyName: "c_channel_map_product_c_channel_id_fkey"
            columns: ["c_channel_id"]
            referencedRelation: "c_channel"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "c_channel_map_product_m_product_id_fkey"
      ...
      c_channel_map_taxcategory: {
        ...
        Relationships: [
          {
            foreignKeyName: "c_channel_map_taxcategory_c_channel_id_fkey"
            columns: ["c_channel_id"]
            referencedRelation: "c_channel"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "c_channel_map_taxcategory_c_taxcategory_id_fkey"
            columns: ["c_taxcategory_id"]
            referencedRelation: "c_taxcategory"
            referencedColumns: ["id"]
          },
      ...
      c_channel_map_uom: {
        ...
        Relationships: [
          {
            foreignKeyName: "c_channel_map_uom_c_channel_id_fkey"
            columns: ["c_channel_id"]
            referencedRelation: "c_channel"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "c_channel_map_uom_c_uom_id_fkey"
            columns: ["c_uom_id"]
            referencedRelation: "c_uom"
            referencedColumns: ["id"]
          },
      ...
      doc_generated_document: {
        ...
        Relationships: [
          {
            foreignKeyName: "doc_generated_document_created_by_fkey"
            columns: ["created_by"]
            referencedRelation: "ad_user"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "doc_generated_document_doc_template_id_fkey"
            columns: ["doc_template_id"]
            referencedRelation: "doc_template"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      l_location: {
        Row: {
          ...
          id: number
          is_active: boolean
          l_countries_iso2: string | null
          l_municipality_id: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "l_location_l_countries_iso2_fkey"
            columns: ["l_countries_iso2"]
            referencedRelation: "l_countries"
            referencedColumns: ["iso2"]
          },
          {
            foreignKeyName: "l_location_l_municipality_id_fkey"
            columns: ["l_municipality_id"]
            referencedRelation: "l_municipality"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "l_location_l_region_id_fkey"
            columns: ["l_region_id"]
            referencedRelation: "l_region"
            referencedColumns: ["id"]
          },
        ]
      }
      l_municipality: {
        ...
        Relationships: [
          {
            foreignKeyName: "c_municipality_c_region_id_fkey"
            columns: ["c_region_id"]
            referencedRelation: "l_region"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "l_municipality_c_country_alpha_2_fkey"
            columns: ["c_country_alpha_2"]
            referencedRelation: "l_country"
            referencedColumns: ["alpha_2"]
          },
          {
            foreignKeyName: "l_municipality_l_countries_iso2_fkey"
            columns: ["l_countries_iso2"]
            referencedRelation: "l_countries"
            referencedColumns: ["iso2"]
          },
      ...
      l_postal_code: {
        ...
        Relationships: [
          {
            foreignKeyName: "l_postal_code_c_country_alpha_2_fkey"
            columns: ["c_country_alpha_2"]
            referencedRelation: "l_country"
            referencedColumns: ["alpha_2"]
          },
      ...
      l_region: {
        ...
        Relationships: [
          {
            foreignKeyName: "l_region_c_country_alpha_2_fkey"
            columns: ["c_country_alpha_2"]
            referencedRelation: "l_country"
            referencedColumns: ["alpha_2"]
          },
    ...
    Functions: {
      ...
      check_attributes_match: {
        Args: { p_rule_attributes: Json; p_product_attributes: Json }
        Returns: boolean
      }
      delete_avatar: {
